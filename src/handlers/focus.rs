...
impl PointerTarget<SharedStrataState> for FocusTarget {
	fn enter(
		&self,
		seat: &Seat<SharedStrataState>,
		data: &mut SharedStrataState,
		event: &MotionEvent,
	) {
		match self {
	...
	fn axis(&self, seat: &Seat<SharedStrataState>, data: &mut SharedStrataState, frame: AxisFrame) {
		match self {
	...
	fn gesture_swipe_update(
		&self,
		_: &smithay::input::Seat<SharedStrataState>,
		_: &mut SharedStrataState,
	...
	fn frame(&self, seat: &Seat<SharedStrataState>, data: &mut SharedStrataState) {
		match self {
...
impl KeyboardTarget<SharedStrataState> for FocusTarget {
	fn enter(
		&self,
		seat: &Seat<SharedStrataState>,
		data: &mut SharedStrataState,
	...
	fn leave(&self, seat: &Seat<SharedStrataState>, data: &mut SharedStrataState, serial: Serial) {
		match self {
